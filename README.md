...
The quality gate now accepts a configurable confidence threshold and includes `evaluate_thresholds` for inspecting the coverage-versus-abstention trade-off. GitHub Actions runs the computer-vision regression suite continuously.
